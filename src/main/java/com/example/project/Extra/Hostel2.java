...
public class Hostel2 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Background Image
        Image backgroundImage = new Image(getClass().getResourceAsStream("/com/example/project/Hostel Image.jpg")); // Provide the path to your image
        ImageView backgroundImageView = new ImageView(backgroundImage);
        backgroundImageView.setFitWidth(800);  // Set the width of the background image
        backgroundImageView.setFitHeight(600); // Set the height of the background image
